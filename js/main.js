...
$(document).ready(function () {
    ...
    setInterval(function () {
        $('.text_header').fadeOut(500, function () {
            var $this = $(this);
            var $text1 = "Be awesome !";
            var $text2 = "Let's be creative !";
            var $text3 = "Design more !"
    ...
    try {
        var images = [
            "/home/ridwanzal/NetBeansProjects/EdoWeb/public_html/myweb/img/work/akad.png",
            '/home/ridwanzal/NetBeansProjects/EdoWeb/public_html/myweb/img/work/hostbin.png',
            '/home/ridwanzal/NetBeansProjects/EdoWeb/public_html/myweb/img/work/prowire.png',
            '/home/ridwanzal/NetBeansProjects/EdoWeb/public_html/myweb/img/work/prowire.png'
        ];
        var ulid = $('#imageList');
        imageLoad.load(images, ulid);
    } catch (e) {
        console.log("err " + e);
    }
});
